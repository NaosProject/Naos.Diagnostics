...
namespace Naos.Diagnostics.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckDrivesReport> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckDrivesReport>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckDrivesReport>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckDrivesReport> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckDrivesReport>()
            .AddScenario(() =>
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckDrivesReport> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckDrivesReport>()
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckDrivesReport>
                {
                    Name = "DriveNameToReportMap should return same 'driveNameToReportMap' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckDrivesReport>();
        ...
        private static readonly DeepCloneWithTestScenarios<CheckDrivesReport> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CheckDrivesReport>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckDrivesReport>
                {
                    Name = "DeepCloneWithDriveNameToReportMap should deep clone object and replace DriveNameToReportMap with the provided driveNameToReportMap",
                    WithPropertyName = "DriveNameToReportMap",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckDrivesReport>();

                        var referenceObject = A.Dummy<CheckDrivesReport>().ThatIs(_ => !systemUnderTest.DriveNameToReportMap.IsEqualTo(_.DriveNameToReportMap));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckDrivesReport>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CheckDrivesReport>().ThatIs(_ => !systemUnderTest.SampleTimeUtc.IsEqualTo(_.SampleTimeUtc));
        ...
        private static readonly CheckDrivesReport ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckDrivesReport>();

        private static readonly EquatableTestScenarios<CheckDrivesReport> EquatableTestScenarios = new EquatableTestScenarios<CheckDrivesReport>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckDrivesReport>
                {
                    Name = "Default Code Generated Scenario",
        ...
        private static readonly ValidModelTestScenarios<CheckDrivesReport> ValidModelTestScenarios = new ValidModelTestScenarios<CheckDrivesReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckDrivesReport>
                {
                    Name = "a dummy CheckDrivesReport should be valid",
                    SystemUnderTest = A.Dummy<CheckDrivesReport>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckDrivesReport___Should_implement_IModel_of_CheckDrivesReport___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckDrivesReport);

                var expectedModelMethods = typeof(IModel<CheckDrivesReport>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckDrivesReport>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckDrivesReport___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckDrivesReport);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckDrivesReport)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.DriveNameToReportMap == null)
                {
                    actual.DriveNameToReportMap.AsTest().Must().BeNull();
                }
                else if (!actual.DriveNameToReportMap.GetType().IsValueType)
                {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckDrivesReport)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckDrivesReport).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckDrivesReport>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckDrivesReport systemUnderTest1 = null;
                CheckDrivesReport systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckDrivesReport systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
