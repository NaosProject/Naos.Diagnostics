...
namespace Naos.Diagnostics.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckSingleDriveReport> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckSingleDriveReport>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckSingleDriveReport>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckSingleDriveReport> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckSingleDriveReport>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CheckSingleDriveReport>
                {
                    Name = "constructor should throw ArgumentOutOfRangeException when parameter 'status' is CheckStatus.Unknown",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckSingleDriveReport>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "status", "Unknown", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckSingleDriveReport> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckSingleDriveReport>()
            .AddScenario(() =>
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckSingleDriveReport>
                {
                    Name = "TotalFreeSpaceInBytes should return same 'totalFreeSpaceInBytes' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckSingleDriveReport>();
                    ...
                    PropertyName = "TotalFreeSpaceInBytes",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CheckSingleDriveReport>
                {
                    Name = "TotalSizeInBytes should return same 'totalSizeInBytes' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CheckSingleDriveReport>();
        ...
        private static readonly DeepCloneWithTestScenarios<CheckSingleDriveReport> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CheckSingleDriveReport>()
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckSingleDriveReport>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<CheckSingleDriveReport>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckSingleDriveReport>
                {
                    Name = "DeepCloneWithTotalFreeSpaceInBytes should deep clone object and replace TotalFreeSpaceInBytes with the provided totalFreeSpaceInBytes",
                    WithPropertyName = "TotalFreeSpaceInBytes",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckSingleDriveReport>();

                        var referenceObject = A.Dummy<CheckSingleDriveReport>().ThatIs(_ => !systemUnderTest.TotalFreeSpaceInBytes.IsEqualTo(_.TotalFreeSpaceInBytes));

                        var result = new SystemUnderTestDeepCloneWithValue<CheckSingleDriveReport>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.TotalFreeSpaceInBytes,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CheckSingleDriveReport>
                {
                    Name = "DeepCloneWithTotalSizeInBytes should deep clone object and replace TotalSizeInBytes with the provided totalSizeInBytes",
                    WithPropertyName = "TotalSizeInBytes",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CheckSingleDriveReport>();

                        var referenceObject = A.Dummy<CheckSingleDriveReport>().ThatIs(_ => !systemUnderTest.TotalSizeInBytes.IsEqualTo(_.TotalSizeInBytes));

                        var result = new SystemUnderTestDeepCloneWithValue<CheckSingleDriveReport>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.TotalSizeInBytes,
                        };
        ...
        private static readonly CheckSingleDriveReport ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckSingleDriveReport>();

        private static readonly EquatableTestScenarios<CheckSingleDriveReport> EquatableTestScenarios = new EquatableTestScenarios<CheckSingleDriveReport>()
            .AddScenario(() =>
        ...
        private static readonly ValidModelTestScenarios<CheckSingleDriveReport> ValidModelTestScenarios = new ValidModelTestScenarios<CheckSingleDriveReport>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckSingleDriveReport>
                {
                    Name = "a dummy CheckSingleDriveReport should be valid",
                    SystemUnderTest = A.Dummy<CheckSingleDriveReport>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckSingleDriveReport___Should_implement_IModel_of_CheckSingleDriveReport___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckSingleDriveReport);

                var expectedModelMethods = typeof(IModel<CheckSingleDriveReport>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckSingleDriveReport>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckSingleDriveReport___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckSingleDriveReport);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckSingleDriveReport)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckSingleDriveReport)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckSingleDriveReport).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckSingleDriveReport>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckSingleDriveReport systemUnderTest1 = null;
                CheckSingleDriveReport systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckSingleDriveReport systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleDriveReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleDriveReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleDriveReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleDriveReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckSingleDriveReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
