...
namespace Naos.Diagnostics.Domain.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CheckDrivesOp> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CheckDrivesOp>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<CheckDrivesOp>
                {
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<CheckDrivesOp> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CheckDrivesOp>();

        private static readonly ConstructorPropertyAssignmentTestScenarios<CheckDrivesOp> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CheckDrivesOp>()
            .AddScenario(() =>
        ...
        private static readonly CheckDrivesOp ReferenceObjectForEquatableTestScenarios = A.Dummy<CheckDrivesOp>();

        private static readonly EquatableTestScenarios<CheckDrivesOp> EquatableTestScenarios = new EquatableTestScenarios<CheckDrivesOp>()
            .AddScenario(() =>
                new EquatableTestScenario<CheckDrivesOp>
                {
                    Name = "Default Code Generated Scenario",
                    ...
                    ObjectsThatAreNotOfTheSameTypeAsReferenceObject = new object[]
                    {
                        ...
                        A.Dummy<int?>(),
                        A.Dummy<Guid>(),
                        A.Dummy<PerformDefaultDiagnosticChecksOp>(),
                    },
                });

        private static readonly ValidModelTestScenarios<CheckDrivesOp> ValidModelTestScenarios = new ValidModelTestScenarios<CheckDrivesOp>()
            .AddScenario(() =>
                new ValidModelTestScenario<CheckDrivesOp>
                {
                    Name = "a dummy CheckDrivesOp should be valid",
                    SystemUnderTest = A.Dummy<CheckDrivesOp>(),
                });
        ...
        public static class StructuralTesting
        {
            ...
            public static void CheckDrivesOp___Should_implement_IModel_of_CheckDrivesOp___When_reflecting()
            {
                // Arrange
                var type = typeof(CheckDrivesOp);

                var expectedModelMethods = typeof(IModel<CheckDrivesOp>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CheckDrivesOp>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CheckDrivesOp___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CheckDrivesOp);
        ...
        public static class CloningTesting
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CheckDrivesOp)systemUnderTest.Clone();
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CheckDrivesOp)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CheckDrivesOp).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class SerializationTesting
        {
            ...
            {
                // Arrange
                var expected = A.Dummy<CheckDrivesOp>();
        ...
        public static class EqualityTesting
        {
            ...
            {
                // Arrange
                CheckDrivesOp systemUnderTest1 = null;
                CheckDrivesOp systemUnderTest2 = null;
            ...
            public static void EqualsOperator___Should_return_false___When_one_side_of_operator_is_null_and_the_other_side_is_not_null()
            {
                ...
                {
                    // Arrange
                    CheckDrivesOp systemUnderTest = null;
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckDrivesReport___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange
                    ReturningOperationBase<CheckDrivesReport> systemUnderTest = null;

                    // Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CheckDrivesReport>)systemUnderTest);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckDrivesReport___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actual = scenario.ReferenceObject.Equals((ReturningOperationBase<CheckDrivesReport>)scenario.ReferenceObject);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckDrivesReport___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatDeriveFromScenarioTypeButAreNotOfTheSameTypeAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckDrivesReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckDrivesReport___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreNotEqualToReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckDrivesReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_ReturningOperationBase_of_CheckDrivesReport___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
                ...
                {
                    // Arrange, Act
                    var actuals = scenario.ObjectsThatAreEqualToButNotTheSameAsReferenceObject.Select(_ => scenario.ReferenceObject.Equals((ReturningOperationBase<CheckDrivesReport>)_)).ToList();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesOp___Should_return_false___When_parameter_other_is_null()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesOp___Should_return_true___When_parameter_other_is_same_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesOp___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesOp___Should_return_false___When_objects_being_compared_have_different_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CheckDrivesOp___Should_return_true___When_objects_being_compared_have_same_property_values()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
