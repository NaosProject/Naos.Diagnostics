    ...
    public partial class CheckDrivesReport : IModel<CheckDrivesReport>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DriveNameToReportMap, options, propertyPathTracker, nameof(this.DriveNameToReportMap));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.OperationUsed, options, propertyPathTracker, nameof(this.OperationUsed));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
