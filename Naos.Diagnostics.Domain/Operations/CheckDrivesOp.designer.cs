    ...
    public partial class CheckDrivesOp : IModel<CheckDrivesOp>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.FailureThreshold, options, propertyPathTracker, nameof(this.FailureThreshold));
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.WarningThreshold, options, propertyPathTracker, nameof(this.WarningThreshold));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
